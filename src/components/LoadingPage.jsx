...
const LoadingPage = ({ onLoadComplete }) => {
  useEffect(() => {
    // Set a timeout equal to the total animation duration (4 seconds in this case)
    const timer = setTimeout(() => {
      onLoadComplete();
    }, 4000); // Adjust this based on your animation duration
  ...
  return (
    <div className="demo">
      ...
      <div className="demo__text">Rishi</div>
    </div>
  );
};
